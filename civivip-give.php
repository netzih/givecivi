 ...
 * Description:     Sync Give donations with CiviCRM contributions. Includes billing address sync, payment method mappings, recurring donations support, and Stripe payment processor integration.
...
final class CivivipGive
{
	...
	private function constants()
	{
		if ( ! defined('CIVIVIPGIVE_VERSION') ) {
			define('CIVIVIPGIVE_VERSION', '0.6.0');
		}
